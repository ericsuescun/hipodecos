class InformsController < ApplicationController
  ...
  private
    ...
    def inform_params
      params.require(:inform).permit(:user_id, :physician_id, :tag_code, :receive_date, :delivery_date, :prmtr_auth_code, :zone_type, :pregnancy_status, :status, :regime, :entity_id, :branch_id, :copayment, :cost, :price)
    end
end
