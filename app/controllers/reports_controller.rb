class ReportsController < ApplicationController
  ...
  def show_rips
    ...
    when "ad_file"
      ...
      send_data file[0..-2], filename: filename, type: 'text/html; charset=utf-8'
    when "af_file"
      if @total_detail_clin.size > 0
  ...
  def show_rips_ap
    ...
    send_data @total_detail[0..-2], filename: filename, type: 'text/html; charset=utf-8'
  ...
  def show_rips_us
    ...
    send_data users[0..-2], filename: filename, type: 'text/html; charset=utf-8'
  end
