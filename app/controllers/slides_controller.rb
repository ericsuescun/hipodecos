class SlidesController < ApplicationController
  ...
  def index
    if params[:yi]
      ...
      @slides = Slide.where(created_at: date_range).select(:id, :inform_id, :user_id, :created_at, :description, :slide_tag, :colored, :tagged, :covered, :stored).group(:inform_id)
    else
      @slides = Slide.all.select(:id, :inform_id, :user_id, :created_at, :description, :slide_tag, :colored, :tagged, :covered, :stored).group(:inform_id)
    end
  end
