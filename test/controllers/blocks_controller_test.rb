...
class BlocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create block" do
    assert_difference('Block.count') do
      post blocks_url, params: { block: { block_tag: @block.block_tag, inform_id: @block.inform_id, stored: @block.stored, user_id: @block.user_id } }
    end
  ...
  test "should update block" do
    patch block_url(@block), params: { block: { block_tag: @block.block_tag, inform_id: @block.inform_id, stored: @block.stored, user_id: @block.user_id } }
