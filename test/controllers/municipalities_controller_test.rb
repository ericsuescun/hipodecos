...
class MunicipalitiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create municipality" do
    assert_difference('Municipality.count') do
      post municipalities_url, params: { municipality: { code: @municipality.code, department: @municipality.department, municipality: @municipality.municipality, order: @municipality.order, score: @municipality.score } }
    end
  ...
  test "should update municipality" do
    patch municipality_url(@municipality), params: { municipality: { code: @municipality.code, department: @municipality.department, municipality: @municipality.municipality, order: @municipality.order, score: @municipality.score } }
