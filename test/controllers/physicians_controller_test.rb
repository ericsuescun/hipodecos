...
class PhysiciansControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create physician" do
    assert_difference('Physician.count') do
      post physicians_url, params: { physician: { cel: @physician.cel, email: @physician.email, inform_id: @physician.inform_id, lastname: @physician.lastname, name: @physician.name, study1: @physician.study1, study2: @physician.study2, tel: @physician.tel, user_id: @physician.user_id } }
    end
  ...
  test "should update physician" do
    patch physician_url(@physician), params: { physician: { cel: @physician.cel, email: @physician.email, inform_id: @physician.inform_id, lastname: @physician.lastname, name: @physician.name, study1: @physician.study1, study2: @physician.study2, tel: @physician.tel, user_id: @physician.user_id } }
