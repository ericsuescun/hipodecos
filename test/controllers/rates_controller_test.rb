...
class RatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post rates_url, params: { rate: { admin_id: @rate.admin_id, description: @rate.description, name: @rate.name } }
    end
  ...
  test "should update rate" do
    patch rate_url(@rate), params: { rate: { admin_id: @rate.admin_id, description: @rate.description, name: @rate.name } }
