...
class RecipientsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recipient" do
    assert_difference('Recipient.count') do
      post recipients_url, params: { recipient: { description: @recipient.description, inform_id: @recipient.inform_id, samples: @recipient.samples, tag: @recipient.tag, user_id: @recipient.user_id } }
    end
  ...
  test "should update recipient" do
    patch recipient_url(@recipient), params: { recipient: { description: @recipient.description, inform_id: @recipient.inform_id, samples: @recipient.samples, tag: @recipient.tag, user_id: @recipient.user_id } }
