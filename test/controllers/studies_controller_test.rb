...
class StudiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create study" do
    assert_difference('Study.count') do
      post studies_url, params: { study: { Inform_id: @study.Inform_id, codeval_id: @study.codeval_id, factor: @study.factor, user_id: @study.user_id } }
    end
  ...
  test "should update study" do
    patch study_url(@study), params: { study: { Inform_id: @study.Inform_id, codeval_id: @study.codeval_id, factor: @study.factor, user_id: @study.user_id } }
