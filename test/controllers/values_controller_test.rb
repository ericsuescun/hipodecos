...
class ValuesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create value" do
    assert_difference('Value.count') do
      post values_url, params: { value: { admin_id: @value.admin_id, codeval_id: @value.codeval_id, cost_id: @value.cost_id, description: @value.description, value: @value.value } }
    end
  ...
  test "should update value" do
    patch value_url(@value), params: { value: { admin_id: @value.admin_id, codeval_id: @value.codeval_id, cost_id: @value.cost_id, description: @value.description, value: @value.value } }
