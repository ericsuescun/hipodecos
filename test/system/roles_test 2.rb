...
class RolesTest < ApplicationSystemTestCase
  ...
  test "creating a Role" do
    ...
    fill_in "Admin", with: @role.admin_id
    fill_in "Description", with: @role.description
    fill_in "Health care rate", with: @role.health_care_rate
    fill_in "Name", with: @role.name
    fill_in "Parafiscal rate", with: @role.parafiscal_rate
    fill_in "Pension rate", with: @role.pension_rate
    fill_in "Rate", with: @role.rate
    fill_in "Time", with: @role.time
